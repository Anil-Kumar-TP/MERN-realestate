  ...
  return (
    <div>
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        ...
        <Link to={'/search'} className='text-xs sm:text-sm text-blue-800 font-black hover:underline'>Let's start now...</Link>
      </div>
      ...
      <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 my-10'>
        ...
        {rentListings && rentListings.length > 0 && (
          <div>
            <div className='my-3'>
              ...
              <Link to={'/search?type=rent'} className='text-sm text-blue-800 hover:underline'>Show more places to rent</Link>
            </div>
            <div className='flex flex-wrap gap-4'>
        ...
        {saleListings && saleListings.length > 0 && (
          <div>
            <div className='my-3'>
              <h2 className='text-2xl font-semibold text-slate-600'>Recent places to sell</h2>
              <Link to={'/search?type=sale'} className='text-sm text-blue-800 hover:underline'>Show more places to sell</Link>
            </div>
            <div className='flex flex-wrap gap-4'>
