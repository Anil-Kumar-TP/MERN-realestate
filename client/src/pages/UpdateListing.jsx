...
export default function CreateListing () {
    ...
    useEffect(() => {  // whenever the page loads and is on updatelisting,fetch the data.
    ...
    const handleChange = (e) => {
        if (e.target.id === 'sale' || e.target.id === 'rent') { // for sell and rent
            setFormData({ ...formData, type: e.target.id });
        }
        if (e.target.id === 'parking' || e.target.id === 'furnished' || e.target.id === 'offer') { //true or false
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate(`/listing/${data._id}`); //data contains an id which is not userRef
        } catch (error) {
    ...
    return (
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <form className='flex flex-col sm:flex-row gap-4' onSubmit={handleSubmit}>
                <div className='flex flex-col flex-1 gap-4'> {/*left div*/}
                    ...
                    <textarea type="text" id="description" placeholder='description' className='border p-3 rounded-lg resize-none' required onChange={handleChange} value={formData.description} />
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <div className='flex gap-4'>
                        ...
                        <button disabled={uploading} type='button' className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80' onClick={handleImageSubmit}>{uploading ? 'uploading' : 'upload'}</button>
                    </div>
